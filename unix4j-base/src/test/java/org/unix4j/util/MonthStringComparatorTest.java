...
public class MonthStringComparatorTest extends AbstractStringComparatorTest {
	...
	public void testCompareGerman() {
		...
		//Determine short months based on JDK version
		//https://bugs.openjdk.java.net/browse/JDK-8212755
		double javaSpecificationVersion = Double.parseDouble(System.getProperty("java.specification.version"));
		final String[] sMonths;
		if(javaSpecificationVersion < 11){
			sMonths =  new String[]{"JAN", "FEB", "M\u00E4R", "APR", "MAI", "JUN", "JUL", "AUG", "SEP", "OKT", "NOV", "DEZ"};
		} else {
			sMonths =  new String[]{"JAN", "FEB", "M\u00E4RZ", "APR", "MAI", "JUNI", "JULI", "AUG", "SEP", "OKT", "NOV", "DEZ"};
		}
