...
public class MonthStringComparator implements Comparator<CharSequence> {
	...
	public MonthStringComparator(DateFormatSymbols symbols) {
		...
		this.shortMonths = cleanShortMonthsOfTrailingDots(symbols.getShortMonths());
	}

	private static String[] cleanShortMonthsOfTrailingDots(String[] shortMonths) {
		String[] copy = shortMonths.clone();
