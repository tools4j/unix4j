 ...
 */
public class ScientificNumberStringComparatorTest {

	private final Random rnd = new Random();
	private final ScientificNumberStringComparator comparator = ScientificNumberStringComparator.INSTANCE;
