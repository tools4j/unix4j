 ...
 * <b>DESCRIPTION</b>
 * <p>
 * The tail utility shall copy its input to the output beginning at a designated place.
 * Copying shall begin at the point in the file indicated by the lines argument.  The last n number of lines
 * shall be returned. If the number given with the lines argument is larger than the number
 * </p>
 * <b>NOTES</b>
 * <p>
 * <ul>
...
public final class Tail {
	...
	public static interface Interface<R> extends CommandInterface<R> {
		/**
		 * @param lines
		 *            the number of lines from the end of the input which will be
		 *            sent to the output. If a negative
