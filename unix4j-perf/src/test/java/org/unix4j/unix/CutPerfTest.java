...
public class CutPerfTest extends AbstractPerfTest {
	...
	public void testCut_10Meg_fields() {
		final Unix4jCommandBuilder command = Unix4j.fromFile(LargeTestFiles.FILE_10_MEG.getFile()).cut(" ", 1,2,3,4);
	...
	public void testCut_10Meg_fieldRange() {
		final Unix4jCommandBuilder command = Unix4j.fromFile(LargeTestFiles.FILE_10_MEG.getFile()).cut(" ", 1, 10);
	...
	public void testCut_10Meg_charRange() {
		int[] charIndexes = {1,5,10,15,20};
		final Unix4jCommandBuilder command = Unix4j.fromFile(LargeTestFiles.FILE_10_MEG.getFile()).cut(charIndexes);
